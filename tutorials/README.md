...
| [Use Cases & Best Practices](use-cases.md) | Common patterns and anti-patterns |
| [Design Guidelines](design-guidelines.md) | Timer slot allocation and lifecycle management |
...
2. [BSP Porting Guide](bsp-porting.md)
3. [Use Cases & Best Practices](use-cases.md)

**Intermediate:**
4. [Configuration & Tuning](configuration-and-tuning.md)
5. [Design Guidelines](design-guidelines.md)
6. [Testing Guide](testing.md)

**Advanced:**
7. [Coroutines Tutorial](coroutines.md)
8. [Architecture Notes](architecture-notes.md)
